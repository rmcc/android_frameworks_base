...
// The ONE apparently only has 4MB, and if you use it to the limit it
// will generate errors in YouTube and some games.

static const int PMEM_SIZE = int(3.9 * 1024 * 1024);
